...
int isAble(sworld world, int x_from, int y_from, int type, int worldsize ); 	/*0 não se pode mexer / 1 pode-se mexer*/
void move(sworld world_from, int x_from, int y_from, sworld world_to, int x_to, int y_to, int worldsize);
void goAnimal(sworld world_init, sworld world_final, int pos, int type, int worldsize); /*TODO hacked here*/
#endif /* MOVER_H_ */
